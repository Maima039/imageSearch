...
export const InputSearch =()=>{
    ...
    const cbReset =()=>{
        ...
        dispatch(actions.fetchAction.fetchImage(''))
    }
    ...
    return (
        <div className="inputSearch">
            ...
            <form className="inputForm" id="myForm" action="imageSearch/imageSearch/frontend/src/component/InputSearch#" onSubmit={cbInput}>
